...
const Gear: React.FC<{ width?: number; height?: number }> = ({ width = 200, height = 200 }) => {
    return (
        <svg className="gear-icon" height={height} width={width} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            <circle 
            ...
            <path
                className="shadow" 
                d="M275.092,511.291c126.162-9.302,226.897-110.037,236.199-236.199L379.197,142.998l-3.751,32.99
                l-83.18-83.18l-116.14,101.707L96.539,205.81l110.645,110.645l-74.38,52.546L275.092,511.291z"
            />
            <path
                className="gear-left" 
                d="M382.928,256c0-10.128-1.221-19.966-3.462-29.408l35.995-20.782l-36.264-62.812l-36.021,20.795
            ...
            <path
                ...
                c19.297-5.744,36.659-15.955,50.91-29.434l36.021,20.795l36.264-62.814l-35.995-20.782
                C381.707,275.966,382.928,266.128,382.928,256z"
            />
            <path
                className="gear-inner" 
                d="M256,181.682c-41.044,0-74.318,33.273-74.318,74.318c0,41.044,33.273,74.318,74.318,74.318
