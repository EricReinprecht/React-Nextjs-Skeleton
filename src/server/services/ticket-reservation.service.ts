import type { TicketReservationFilter } from "@shared/types";
...
export const getTicketReservationsPaginated = (page = 1, filter?: TicketReservationFilter) => reservationRepository.getTicketReservationsPaginated(page, filter);
