...
export const getTicketsPaginated = (
    page = 1,
    filter?: Partial<TicketRow>,
    userId?: string,
    sorting?: TableSort[],
) => ticketRepository.getTicketsPaginated(page, filter, userId, sorting);
export const countTickets = (filter?: Partial<TicketRow>, userId?: string) =>
    ticketRepository.countTickets(filter, userId);
